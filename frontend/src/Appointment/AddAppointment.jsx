...
export default function AddApointment() {
    ...
    const { name, namePatient } = location.state ? location.state : { name: null, namePatient: namePatient };
    const nameFromEditStaff = name === null ? '' : name;
    const nameFromReadPatient = namePatient === null ? '' : namePatient;
    ...
    const [value, setValue] = useState({
        ...
        patientname: nameFromReadPatient ? nameFromReadPatient : '',
        feestatus: false, // Thiết lập mặc định là false
        completed: false, // Thiết lập mặc định là false
    });
    // console.log('nameFromReadPatient ', namePatient)
    useEffect(() => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const res = await AxiosInstance.post(`appointments/`, value)
            console.log(res);
            if (res.status === 201) {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-8">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <select className="form-control ms-2" id="doctorInput" value={value.doctorname} onChange={(e) => setValue({ ...value, doctorname: e.target.value })}>
