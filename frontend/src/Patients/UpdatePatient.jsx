...
function UpdatePatient() {
    ...
    const handleUpdatePatient = async (event) => {
        ...
        try {
            const res = await AxiosInstance.put(`patients/${id}/`, values)
            console.log(res);
            if (res.status === 200) {
                            ...
                            <form onSubmit={handleUpdatePatient}>
                                ...
                                <div className="row mt-3">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <textarea className="form-control" aria-label="With textarea" id="basicurl" placeholder={`${values.address}`} value={values.address} onChange={e => setValues({ ...values, address: e.target.value })}></textarea>
                                    </div>
